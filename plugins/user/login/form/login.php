        ...
        <!-- form start-->
            <form  target="_self" method="post" action="<?= $current_url?>" name="frmlogin">
                ...
                <tr>
                    ...
                    <tr>
                        <td valign="top" align="left"><INPUT onclick="clean_loginname();" class="login_box"  type="text" name="loginname" id="loginname"  title="<?= $msg_default_username ?>"  value="<?= $msg_default_username ?>" ></td>
